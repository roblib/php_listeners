...
require_once 'includes/Relationships.php';
  ...
  /**
   * This function adds a cmodel relationship to the object RELS-EXT datastream.
   *
   * @param string $pid
   ...
   *
   */
  function addCModelToObject($pid, $dsid, $outputdsid, $label, $cmodel) {
    $params = array(
      'class' => 'Relationship',
  ...
  /**
   * This function removes a cmodel relationship from the object RELS-EXT datastream.
   *
   * @param string $pid
   *  The pID of fedora Object which to read and write
   *
   ...
   * @return int
   */
  function removeCModelFromObject($pid, $dsid, $outputdsid, $label, $cmodel) {
    $params = array(
      'class' => 'Relationship',
