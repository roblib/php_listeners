...
class IslandoraService {
	...
	function OCR_L($pid, $dsid = 'JPEG', $label = 'Scanned text', $language = 'eng')
        {
                $result = -1;
                $this->log->lwrite("Function OCR starting...", 'SOAP_LOG', $pid, $dsid, NULL, 'INFO');
                try {
        ...
        function HOCR($pid, $dsid = 'JPEG', $label = 'HOCR', $language = 'eng')
        {
		$result = -1;
	...
	function HOCR_L($pid, $dsid = 'JPEG', $label = 'HOCR', $language = 'eng')
        {
                $result = -1;
                $this->log->lwrite("Function HOCR starting...", 'SOAP_LOG', $pid, $dsid, NULL, 'INFO');
                try {
	...
	function ENCODED_OCR_L($pid, $dsid = 'JPEG', $label = 'Encoded OCR', $language = 'eng')
        {
                $result = -1;
                $this->log->lwrite("Function ENCODED_OCR starting...", 'SOAP_LOG', $pid, $dsid, NULL, 'INFO');
                try {
	...
	function Scholar_PDFA_L($pid, $dsid = 'JPG', $label = 'PDF')
        {
                $result = -1;
                $this->log->lwrite("Function Scholar_PDFA starting...", 'SOAP_LOG', $pid, $dsid, NULL, 'INFO');
                try {
	...
	function Scholar_Policy_L($pid, $dsid = 'OBJ', $label = "Embargo policy - Both")
        {
                $result = -1;
                $this->log->lwrite("Function Scholar_Policy starting...", 'SOAP_LOG', $pid, $dsid, NULL, 'INFO');
                try {
